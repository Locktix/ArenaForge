...
function get_codex_for_brute(int $bruteId): array
{
    ...
    $weapons = $pdo->query("SELECT id, name, icon_path, rarity FROM weapons ORDER BY FIELD(rarity,'commun','rare','epique'), id")->fetchAll();
    $skills  = $pdo->query("SELECT id, name, description, icon_path, rarity FROM skills ORDER BY FIELD(rarity,'commun','rare','epique'), id")->fetchAll();
    $pets    = $pdo->query("SELECT id, name, description, icon_path, rarity FROM pets ORDER BY FIELD(rarity,'commun','rare','epique'), id")->fetchAll();
